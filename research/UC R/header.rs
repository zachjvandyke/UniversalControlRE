...
(perhaps UTF-16 by accident?), 0xsuch as g,h,j,k etc.

I'm reffering to those occurences calling them "Address Pair",
for the lack of a better name/understanding.

Notably, 0xa response to the PV message swaps those two values around
...
* KA - some system packet, 0xlike heartbeat or something
...
// then 4 bytes - 06, 0x00, 0x4b(K), 0x41(A)
...
// this was gathered later during testing that's why it has no header
pub const PL_EXAMPLE = [
// AddressPair
0x66,0x00,0x6B,0x00,
// line/ch1/presets/preset
0x6C, 0x69, 0x6E, 0x65, 0x2F, 0x63, 0x68, 0x31, 0x2F, 0x70, 0x72, 0x65, 0x73, 0x65, 0x74, 0x73, 0x2F, 0x70, 0x72, 0x65, 0x73, 0x65, 0x74,
// 7x 00 of padding
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
// lines of text
  // Broadcast\n
  0x42, 0x72, 0x6F, 0x61, 0x64, 0x63, 0x61, 0x73, 0x74, 0x0A,
  // Vocal\n
  0x56, 0x6F, 0x63, 0x61, 0x6C, 0x0A,
  // Acoustic Guitar\n
  0x41, 0x63, 0x6F, 0x75, 0x73, 0x74, 0x69, 0x63, 0x20, 0x47, 0x75, 0x69, 0x74, 0x61, 0x72, 0x0A,
  // etc etc.
  0x45, 0x6C, 0x65, 0x63, 0x74, 0x72, 0x69, 0x63, 0x20, 0x47, 0x75, 0x69, 0x74, 0x61, 0x72, 0x0A,
  0x56, 0x69, 0x6E, 0x74, 0x61, 0x67, 0x65, 0x20, 0x43, 0x68, 0x61, 0x6E, 0x6E, 0x65, 0x6C, 0x0A, 0x53, 0x6C, 0x61, 0x70, 0x20, 0x45, 0x63, 0x68, 0x6F, 0x0A, 0x44, 0x65, 0x74, 0x75, 0x6E, 0x65, 0x64, 0x20, 0x56, 0x6F, 0x63, 0x61, 0x6C, 0x0A, 0x52, 0x6F, 0x62, 0x6F, 0x74, 0x0A, 0x70, 0x72, 0x65, 0x73, 0x65, 0x74, 0x73, 0x2F, 0x0A, 0x45, 0x6D, 0x70, 0x74, 0x79, 0x0A, 0x45, 0x6D, 0x70, 0x74, 0x79, 0x0A, 0x45, 0x6D, 0x70, 0x74, 0x79, 0x0A, 0x45, 0x6D, 0x70, 0x74, 0x79, 0x0A, 0x45, 0x6D, 0x70, 0x74, 0x79,
  // at some point the preset names have "presets/"
  // then "Empty\n"
  // ends with a \00
  0x00
]
